...
class Spells:
    ...
    def cast_fireball(self):
        ...
        Screen.get_instance().message('The fireball explodes, burning everything within ' + str(Spells.FIREBALL_RADIUS) + ' tiles!', libtcod.orange)

        for obj in objects: #damage every fighter in range, including the player
            if obj.distance(x, y) <= Spells.FIREBALL_RADIUS and obj.class_name:
                Screen.get_instance().message('The ' + obj.name + ' gets burned for ' + str(Spells.FIREBALL_DAMAGE) + ' hit points!', libtcod.orange)
